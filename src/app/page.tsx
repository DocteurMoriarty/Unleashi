    ...
    <ClientLayout>
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <section className="bg-white shadow-md rounded-lg p-6 mb-8 max-w-2xl w-full">
          ...
          <ul className="list-disc list-inside space-y-3">
            <li className="flex items-center">
              ...
              <span>
                Exprimez-vous sans retenue : Publiez vos pensées, idées et
                créations sans aucune censure. Ici, votre voix compte !
              </span>
            </li>
            <li className="flex items-center">
              <span className="mr-2 text-green-500">🤝</span>
              <span>
                Connectez-vous avec d'autres passionnés : Rejoignez une
                communauté dynamique d’utilisateurs partageant vos intérêts.
              </span>
            </li>
            <li className="flex items-center">
              <span className="mr-2 text-green-500">🌈</span>
              <span>
                Partagez vos expériences : Racontez vos histoires, partagez vos
                succès et vos défis.
              </span>
            </li>
            <li className="flex items-center">
              <span className="mr-2 text-green-500">📈</span>
              <span>
                Restez informé : Suivez les dernières tendances et les sujets
        ...
        <section className="bg-blue-500 text-white rounded-lg p-6 max-w-2xl w-full">
          ...
          <p className="mb-4">
            Inscrivez-vous dès maintenant et plongez dans un univers où votre
            créativité et votre voix sont à l’honneur.
          </p>
